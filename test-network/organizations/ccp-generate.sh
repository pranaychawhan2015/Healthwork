...
echo "$(json_ccp $ORG $P0PORT $P1PORT $CAPORT $PEERPEM $CAPEM $CERT0 $CERT1 $KEY0 $KEY1)" > organizations/peerOrganizations/org1.example.com/connection-org1.json
echo "$(yaml_ccp $ORG $P0PORT $P1PORT $CAPORT $PEERPEM $CAPEM $CERT0 $CERT1 $KEY0 $KEY1)" > organizations/peerOrganizations/org1.example.com/connection-org1.yaml
...
echo "$(json_ccp $ORG $P0PORT $P1PORT $CAPORT $PEERPEM $CAPEM $CERT0 $CERT1 $KEY0 $KEY1)" > organizations/peerOrganizations/org2.example.com/connection-org2.json
echo "$(yaml_ccp $ORG $P0PORT $P1PORT $CAPORT $PEERPEM $CAPEM $CERT0 $CERT1 $KEY0 $KEY1)" > organizations/peerOrganizations/org2.example.com/connection-org2.yaml

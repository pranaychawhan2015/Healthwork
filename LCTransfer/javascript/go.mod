...
require (
	github.com/hyperledger-labs/fabric-opssc/configtx-cli v0.0.0-20220217023658-aafcba9d4260
	github.com/hyperledger/fabric-sdk-go v1.0.0-rc1
	github.com/hyperledger/fabric-test/tools/operator v0.0.0-20220113135250-c1a27b3e73fc
)
...
require (
	...
	github.com/fentec-project/gofe v0.0.0-20220509115457-83f5523272f1 // indirect
